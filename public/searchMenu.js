    ...
    xhttp.onreadystatechange=function(){
        if(this.readyState==4 && this.status==200)
        {
            ...
            jsonobj.forEach((item,index)=>{
                ...
                column=document.createElement("td");
                column.innerHTML="<img src='/uploads/" + item.image + "' alt='Image' style='width: 50px; height: 50px;'>";
                row.appendChild(column);
                 ...
                 column.innerHTML = "<a href='/UpdateMenu?id=" + item.id + "'><i class='fa-regular fa-pen-to-square'></i></a>";
                  ...
                  row.appendChild(column);
                    ...
                    column=document.createElement("td");
                  column.innerHTML = "<a href='/DeleteMenu?id=" + item.id + "'><i class='fa-solid fa-trash text-danger'></a>";
                  row.appendChild(column);
